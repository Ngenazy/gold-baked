...
import WaitingJFeeConfPanel from './WaitingJFeeConfPanel';
...
import CapitalFeesPool      from './CapitalFeesPool';
    ...
    return(
      <BrowserRouter>
          <Switch>
            ...
            <PrivateRoute exact path="/wait-jfee-confirmation"  component={ WaitingJFeeConfPanel} />
            ...
            <PrivateRoute exact path="/xxx35xxx"                component={ CapitalFeesPool     } />
